...
?>
	<div id="delquestion" onmouseover="mouseover()" class="questionsview_del">
		<a href="<?php echo BASE_PATH; ?>/questions/del/<?php echo $question['id']; ?>">x</a>
	</div>
<?php
		}
?>
...
<div class="questionsview_answer" id="a<?php echo $question['id'];?>">
	<div class="questionsgrid_title">
		<a href="<?php echo BASE_PATH;?>/questions/view/<?php echo $question['id'];?>/<?php echo $question['slug'];?>"><?php echo $question['title'];?></a>
		<br/><span class="questionsgrid_description"><a href="<?php echo BASE_PATH;?>/questions/view/<?php echo $question['id'];?>/<?php echo $question['slug'];?>"><?php echo $question['description'];?></a></span>
		<div style="clear:both"></div>
...
<?php } else { ?>
	<h3>Sorry, we could not find what you were looking for. You may want to have a look at <a href="<?php echo BASE_PATH;?>/tags">tags</a>.</h3>
<?php } ?>